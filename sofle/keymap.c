...
[NUM] = LAYOUT(
  KC_NO,   KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,                        KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
  KC_NO,   KC_LBRC, KC_7,     KC_8,     KC_9,     KC_RBRC,                         KC_GRV,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
  KC_NO,   KC_SCLN, KC_4,     KC_5,     KC_6,     KC_EQL,                          KC_LSFT,   KC_LCTL, KC_LALT, KC_LGUI, KC_NO,   KC_NO,
